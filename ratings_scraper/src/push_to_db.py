...
indices = [
	'CREATE INDEX idx_cc_oq_taen ON ratings(course_code, original_question, text_answer_en);',
	'CREATE INDEX idx_cc_oq_tafr ON ratings(course_code, original_question, text_answer_fr);'
]
