...
_check_column(logger, regs['month_fr'].unique(), unique_vals.MONTH_FR)
...
_check_column(logger, regs['offering_region_en'].unique(), unique_vals.REGION_EN)
logger.debug('7/16: Column \'offering_region_en\' verified.')

# Check column 'offering_region_fr'
_check_column(logger, regs['offering_region_fr'].unique(), unique_vals.REGION_FR)
logger.debug('8/16: Column \'offering_region_fr\' verified.')

# Check column 'offering_province_en'
_check_column(logger, regs['offering_province_en'].unique(), unique_vals.PROVINCE_EN)
logger.debug('9/16: Column \'offering_province_en\' verified.')

# Check column 'offering_province_fr'
_check_column(logger, regs['offering_province_fr'].unique(), unique_vals.PROVINCE_FR)
logger.debug('10/16: Column \'offering_province_fr\' verified.')

# Check column 'learner_province_en'
_check_column(logger, regs['learner_province_en'].unique(), unique_vals.PROVINCE_EN)
logger.debug('11/16: Column \'learner_province_en\' verified.')

# Check column 'learner_province_fr'
_check_column(logger, regs['learner_province_fr'].unique(), unique_vals.PROVINCE_FR)
